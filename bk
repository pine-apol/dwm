...
static const char col_cyan[]        = "#376794";
...
static const Key keys[] = {
	...
	{ 0, XK_F7, spawn, SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -5%") },
        ...
        { 0, XK_F10, spawn, SHCMD("pactl set-sink-volume @DEFAULT_SINK@ 50%") },
        { 0, XK_F11, spawn, SHCMD("pactl set-sink-volume @DEFAULT_SINK@ 100%") },
